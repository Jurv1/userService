...
func (x *MutateUserRequest) Reset() {
	*x = MutateUserRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MutateUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MutateUserRequest) ProtoMessage() {}

func (x *MutateUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MutateUserRequest.ProtoReflect.Descriptor instead.
func (*MutateUserRequest) Descriptor() ([]byte, []int) {
	return file_proto_user_user_proto_rawDescGZIP(), []int{4}
}

func (x *MutateUserRequest) GetInfo() string {
	if x != nil {
		return x.Info
	}
	return ""
...
type MutateUserResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MutateUserResponse) Reset() {
	*x = MutateUserResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MutateUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MutateUserResponse) ProtoMessage() {}

func (x *MutateUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_user_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MutateUserResponse.ProtoReflect.Descriptor instead.
func (*MutateUserResponse) Descriptor() ([]byte, []int) {
	return file_proto_user_user_proto_rawDescGZIP(), []int{5}
}

func (x *MutateUserResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x11, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x2e, 0x0a, 0x12, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65,
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xc7, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x3f, 0x0a, 0x0a, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4d, 0x75,
	0x74, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x42, 0x19, 0x5a, 0x17, 0x62, 0x75, 0x73, 0x68, 0x6d, 0x61, 0x6e, 0x6f, 0x76, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x76, 0x31, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_user_user_proto_goTypes = []any{
	(*GetUserRequest)(nil),     // 0: delivery.GetUserRequest
	(*GetUserResponse)(nil),    // 1: delivery.GetUserResponse
	(*CreateUserRequest)(nil),  // 2: delivery.CreateUserRequest
	(*CreateUserResponse)(nil), // 3: delivery.CreateUserResponse
	(*MutateUserRequest)(nil),  // 4: delivery.MutateUserRequest
	(*MutateUserResponse)(nil), // 5: delivery.MutateUserResponse
}
var file_proto_user_user_proto_depIdxs = []int32{
	0, // 0: delivery.UserService.GetUser:input_type -> delivery.GetUserRequest
	2, // 1: delivery.UserService.CreateUser:input_type -> delivery.CreateUserRequest
	4, // 2: delivery.UserService.MutateUser:input_type -> delivery.MutateUserRequest
	1, // 3: delivery.UserService.GetUser:output_type -> delivery.GetUserResponse
	3, // 4: delivery.UserService.CreateUser:output_type -> delivery.CreateUserResponse
	5, // 5: delivery.UserService.MutateUser:output_type -> delivery.MutateUserResponse
...
func file_proto_user_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_user_user_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*MutateUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_user_user_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*MutateUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
