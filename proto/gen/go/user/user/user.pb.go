...
var file_proto_user_user_proto_goTypes = []any{
	...
	(*MutateUserRequest)(nil),  // 4: user.MutateUserRequest
	(*MutateUserResponse)(nil), // 5: user.MutateUserResponse
}
var file_proto_user_user_proto_depIdxs = []int32{
	...
	4, // 2: user.UserService.MutateUser:input_type -> user.MutateUserRequest
	...
	5, // 5: user.UserService.MutateUser:output_type -> user.MutateUserResponse
